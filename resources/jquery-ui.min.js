    ...
    (e.widget = function (t, i, s) {
      ...
      return (
        ...
        (r.prototype = e.widget.extend(
          ...
          l,
          { constructor: r, namespace: h, widgetName: t, widgetFullName: a }
        )),
        n
    ...
    (e.widget.bridge = function (t, i) {
      ...
      e.fn[t] = function (n) {
        var r = "string" == typeof n,
          ...
          l = this;
        return (
          (n = !r && o.length ? e.widget.extend.apply(null, [n].concat(o)) : n),
          r
            ? this.each(function () {
                var i,
                  a = e.data(this, s);
        ...
        (e.fn.position = function (a) {
          ...
          return (
            ...
            this.each(function () {
              ...
              "right" === a.my[0]
                ? (N.left -= d)
                : "center" === a.my[0] && (N.left -= d / 2),
                "bottom" === a.my[1]
                  ? (N.top -= c)
                  : "center" === a.my[1] && (N.top -= c / 2),
                (N.left += M[0]),
                (N.top += M[1]),
                n || ((N.left = l(N.left)), (N.top = l(N.top))),
                ...
                a.using &&
                  (h = function (e) {
                    ...
                    d > f && f > o(t + i) && (l.horizontal = "center"),
                      c > g && g > o(s + n) && (l.vertical = "middle"),
                      (l.important =
                        r(o(t), o(i)) > r(o(s), o(n))
                          ? "horizontal"
                          : "vertical"),
                      a.using.call(this, e, l);
                  }),
                u.offset(e.extend(N, { using: h }));
            })
          );
        }),
        (e.ui.position = {
          fit: {
            left: function (e, t) {
              var i,
                ...
                l = a - o,
                h = o + t.collisionWidth - n - a;
              t.collisionWidth > n
                ? l > 0 && 0 >= h
                  ? ((i = e.left + l + t.collisionWidth - n - a),
                    (e.left += l - i))
                  : (e.left =
                      h > 0 && 0 >= l
                        ? a
            ...
            top: function (e, t) {
              var i,
                ...
                l = a - o,
                h = o + t.collisionHeight - n - a;
              t.collisionHeight > n
                ? l > 0 && 0 >= h
                  ? ((i = e.top + l + t.collisionHeight - n - a),
                    (e.top += l - i))
                  : (e.top =
                      h > 0 && 0 >= l
                        ? a
          ...
          flip: {
            left: function (e, t) {
              var i,
                ...
                m = -2 * t.offset[0];
              0 > u
                ? ((i = e.left + c + p + m + t.collisionWidth - r - n),
                  (0 > i || o(u) > i) && (e.left += c + p + m))
                : d > 0 &&
                  ((s =
                    e.left - t.collisionPosition.marginLeft + c + p + m - l),
                  (s > 0 || d > o(s)) && (e.left += c + p + m));
            },
            top: function (e, t) {
              var i,
                s,
                ...
                f = -2 * t.offset[1];
              0 > u
                ? ((s = e.top + p + m + f + t.collisionHeight - r - n),
                  e.top + p + m + f > u &&
                    (0 > s || o(u) > s) &&
                    (e.top += p + m + f))
                : d > 0 &&
                  ((i = e.top - t.collisionPosition.marginTop + p + m + f - l),
                  e.top + p + m + f > d &&
                    (i > 0 || d > o(i)) &&
                    (e.top += p + m + f));
            },
      ...
      (p.style.cssText = "background-color:rgba(1,1,1,.5)"),
        ...
        m(u, function (s, a) {
          var n = a.props,
            ...
            u = a.from;
          (h.fn[s] = function (s) {
            if ((l && !this[r] && (this[r] = l(this._rgba)), s === t))
              return this[r].slice();
            var a,
              o = e.type(s),
